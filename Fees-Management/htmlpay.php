...
<head>
    ...
    <!-- BOOTSTRAP STYLES-->
    <link href="htmlpay.css" rel="stylesheet" />
    <!-- FONTAWESOME STYLES-->
    <link href="htmlpay.css" rel="stylesheet" />
       <!--CUSTOM BASIC STYLES-->
    <link href="htmlpay.css" rel="stylesheet" />
    ...
    <link href="htmlpay.css" rel="stylesheet" />
    <!-- GOOGLE FONTS-->
    <link href='htmlpay.css' rel='stylesheet' type='text/css' />
...
////////////////////////////
 $("#tSortable22").dataTable({
                  ...
                  'bProcessing' : true,
				  'bServerSide': true,
                  'sAjaxSource': "database.php?type=feesearch",
...
display:none;
  ...
  <div class="modal fade" id="myModal" role="dialog">
    ...
    <div id="footer-sec">
    School Fees Payment System | Brought To You By : <a href="htmlpay.html" target="_blank">Code-Projects</a>
    </div>
   
  
    <!-- BOOTSTRAP SCRIPTS -->
    <script src="js/htmlpay.js"></script>
    <!-- METISMENU SCRIPTS -->
    <script src="js/jquery.htmlpay.js"></script>
       <!-- CUSTOM SCRIPTS -->
    <script src="js/htmlpay.js"></script>
